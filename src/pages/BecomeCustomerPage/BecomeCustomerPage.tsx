...
const BecomeCustomer = () => {
  ...
  const handleSubmit = (e: any) => {
    ...
    if (Object.values(formValues).every((x: any) => x !== "")) {
      ...
      axios
        .post(
          "https://api.msolcsptest.com/notify/v1/portalmessage",
          requestBody,
          {
            headers: {
          ...
          <form className="customerForm" onSubmit={handleSubmit}>
              ...
              <Grid container direction="row" spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                  ...
                  <FormControl fullWidth>
                    ...
                    >
                      <MenuItem
                        key="broucher-post-card"
                        value="broucher-post-card"
                      >
                        Brochure/Post Card
                      </MenuItem>
            ...
            >
              ...
              <Grid item md={6}>
                ...
                > */}
                <div className="d-flex justify-content-end p-tb-8">
