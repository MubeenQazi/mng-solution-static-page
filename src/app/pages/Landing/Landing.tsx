...
import cta1 from "../../../../public/images/cta.png";
          ...
          <Grid container spacing={2} marginTop={10}>
            ...
            <Grid className="home-about-sec" item xs={12} md={6} marginTop={5}>
              ...
              <p>
                ...
                Choose cost-effective cloud solutions to move your
                infrastructure and applications to the cloud. Our goal is to
                make technology easier and more accessible to everyone. We work
                with the latest technologies so you can focus on running your
                business.
              </p>
            </Grid>
          </Grid>
